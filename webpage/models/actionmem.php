   ...
   foreach($folder as $name)
   {
    $output .= '
     <tr>
      ...
      <td><button type="button" name="train" data-name="'.$name.'" class="train btn btn-default ">Queue File for Classify</button></td>
     </tr>';
   }
  }
  else
         ...
         if($_FILES["upload_file"]["name"] != '')
{
 ...
 if(in_array($extension, $allowed_extension))
 {
    $new_file_name = $_FILES["upload_file"]["name"];
     ...
     if (!file_exists("D:/xampp/htdocs/mtlbl/webpage/users/$userName/classify/$a")) {
     mkdir("D:/xampp/htdocs/mtlbl/webpage/users/$userName/classify/$a");
         $path = "D:/xampp/htdocs/mtlbl/webpage/users/$userName/classify/$a/" . $new_file_name;
     }
     else{
     $path = "D:/xampp/htdocs/mtlbl/webpage/users/$userName/classify/$a/" . $new_file_name; }
