...
([function (t, e, n) {
			...
			var g = function (t) {
				function e(t, n, o, i) {
					...
					(this, e),
					(r = v(this, b(e).call(this, i, "".concat(c.prefix, "-").concat(Math.floor(Date.now() - 100 * Math.random())), "".concat(c.prefix, " ").concat(c.prefix, "-").concat(n), "animation-duration: ".concat(o.toSecs(o.animationDuration), ";"), o))).updateType(n),
					r.setInnerHtml(t),
					r
				}
				var n,
			...
			var S = function (t) {
				function e(t) {
					...
					return (n = _(this, T(e).call(this, document.body, u.ids.wrapper, null, s, i)))[u.ids.confirmOk] = r,
				...
				(o = [{
							...
							value: function (t) {
								...
								case "Escape":
									...
									this.delete();
								case "Tab":
									if (t.preventDefault(), "confirm" !== this.type)
										return !0;
									var e = this.okBtn;
									t.shiftKey ? document.activeElement.id == u.ids.confirmOk && (e = this.cancelBtn) : document.activeElement.id !== u.ids.confirmCancel && (e = this.cancelBtn),
									e.focus()
								}
							}
						}, {
