...
<html>
<head>
    <title>My Document Page Admin</title>
    <style>
        table {
    ...
    <table >
        ...
        <?php
                  $conn=mysqli_connect("localhost", "root", "", "deneme") or die("Unable to connect".$conn-> connect_error);
                    ...
                    $sql="SELECT document.docId,document.docName,users.userType,document.userId,users.userId FROM document,users WHERE document.userId=users.userId ";
